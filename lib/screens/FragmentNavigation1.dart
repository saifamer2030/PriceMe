...
class FragmentPriceMe1 extends StatefulWidget {
  FragmentPriceMe1();

  @override
  _FragmentPriceMe1State createState() => _FragmentPriceMe1State();
}

class _FragmentPriceMe1State extends State<FragmentPriceMe1> {
