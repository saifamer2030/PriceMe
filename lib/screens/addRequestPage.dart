            ...
            children: [
              ...
              Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      "ضع وصفا أو  صورة للقطعة المطلوبة",
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text("أعرض قطع الغيار أو سيارة سكراب كاملة",
                    style: TextStyle(
                        color: Colors.black,
                        fontSize: 12,
                        fontWeight: FontWeight.w600)),
                ...
                title: Text(
                  "هل تريد بيع السيارة سكراب كاملة ؟",
                  textAlign: TextAlign.right,
                  style: TextStyle(
                      color: Colors.black,
                      fontSize: 12,
