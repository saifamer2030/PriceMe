...
class OfferDetail extends StatefulWidget {
  ...
  OfferDetail(this.userId, this.advid);
...
class _OfferDetailState extends State<OfferDetail> {
 ...
 //String cNew;
  ...
  void initState() {
        ...
        if (data.documents.length > 0) {
          setState(() {
            ...
            cproblemtype = data.documents[0].data['cproblemtype'];
             price = data.documents[0].data['price'];
    ...
    commentsReference.collection("offercommentsofferdata").document(widget.userId).collection(widget.advid)
        .getDocuments()
...
//                                                });
  ...
  void createRecord() {
    ...
    setState(() {
      ...
      Firestore.instance.collection('offercommentsofferdata').document(widget.userId).collection(widget.advid).document();
